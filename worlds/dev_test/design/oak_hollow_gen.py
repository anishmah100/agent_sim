...
Run: python worlds/dev_test/design/oak_hollow_gen.py
Writes: worlds/dev_test/world.json
...
def main() -> None:
    ...
    out = {
        ...
        "width_tiles": W,
        "height_tiles": H,
        "_design": "Generated by worlds/dev_test/design/oak_hollow_gen.py — edit there and re-run.",
        "tiles_legend": {
